import { fetchStopTimes, fetchStopTimesByStopId, fetchStopTimeByTripIdAndStopId } from '../data/files/stop-times-repo.js';
...
export const getStopTimeByTripIdAndStopId = async (tripId, stopId) => {
  return await fetchStopTimeByTripIdAndStopId(tripId, stopId);
};
